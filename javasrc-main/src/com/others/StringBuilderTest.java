 ...
 * StringBuilder es más rápida y preferible para subprocesos únicos
 */
/*
...
public class StringBuilderTest {
	...
	public static void main(String[] args) {
		...
		// Genera un StringBuilder y le añade algunos elementos
		...
		// Obtiene el valor de StringBuilder como String y lo imprime
